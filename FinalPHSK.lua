...
-- Update  : - Kembali pakai logic VIM 100% dari v46.38 (Zero-Typo)
--           - Fitur Delay Enter (Slider) & Enter 1x saja
--           - UI Kiri/Tengah/Kanan Dibalik + Auto Play & Auto Join sejajar
--           - List Kata & Output disetarakan ukurannya
--           - Export & Import DB+Blk digabung jadi 1 Button
--           - Default Filter: Terpendek & Tanpa Filter
-- =================================================================
...
local EnterDelay     = 0.10  -- NEW FEATURE: ENTER DELAY
...
-- ============================================================
-- MAIN SCREEN GUI (REDESIGNED LAYOUT)
-- ============================================================
...
local function UpdateScale()
    ...
    -- Disable scaling up on phone screens to prevent UI from being too big
...
-- ── POSISI KOLOM (LX = KIRI, MX = TENGAH, RX = KANAN) ─────────────
